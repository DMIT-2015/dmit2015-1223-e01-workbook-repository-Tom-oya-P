...
public class OpenWeatherApiClientView implements Serializable {
    ...
    @Inject
    @ConfigProperty(name = "org.openweathermap.api.DefaultCity", defaultValue = "Edmonton") // The name is defined in src/main/resources/META-INF/microprofile-config.properties file or an O/S environment variable
    @Getter @Setter
